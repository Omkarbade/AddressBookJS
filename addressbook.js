...
let contactindex = obtainingContactWithName("Mahesh");
if (contactindex != -1) {
  console.log("Before Updation : ");
  console.log(contacts.toString());
  contacts[contactindex].firstName = "Mahesh";
...
console.log(
  "Number of contacts present in the city:  " + getCountByCity("Jambu")
);
console.log(
